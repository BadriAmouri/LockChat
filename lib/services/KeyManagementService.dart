...
Future<Map<String, dynamic>> rotateKeyIfNeeded(int senderId, int recipientId, String sendername) async {
  try {
    final Uri checkRotationUrl = Uri.parse(
      'http://10.80.1.212:5000/api/encryption/shouldRotateKey/$senderId/$recipientId',
    );
    ...
    if (response.statusCode == 200) {
      ...
      if (shouldRotate) {
        ...
        final Uri storeKeyUrl = Uri.parse('http://10.80.1.212:5000/api/encryption/storeEncryptedKey');
        ...
        final Uri fetchKeyUrl = Uri.parse(
          'http://10.80.1.212:5000/api/encryption/getEncryptedKey',
 ...
 */
 ...
 Future<ECPublicKey> retrievePublicKeyFromBackend(int username) async {
  final url = Uri.parse('http://10.80.1.212:5000/api/encryption/users/$username/publicKey');
