...
class MessageAPIService {
  static const String _baseUrl = 'http://10.80.1.212:5000/api/encryption'; // Change if using a real server
  static const String _decbaseUrl = 'http://10.80.1.212:5000/api/decryption';
