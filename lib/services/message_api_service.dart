...
class MessageAPIService {
  static const String _baseUrl = 'https://lock-chat-backend.vercel.app/api/encryption'; // Change if using a real server
  static const String _decbaseUrl = 'https://lock-chat-backend.vercel.app/api/decryption';
